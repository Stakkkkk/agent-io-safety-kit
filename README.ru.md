...
Да, такой раздел нужен. Он превращает проект из “набора файлов” в понятный контракт для AI-агента. Главное правило: не подбирать кавычки или кодировки повторными попытками, а после первой проблемы переходить к детерминированному пути.

Минимальный текст для агентского entry-файла:
...
Загружай указанный skill перед соответствующей операцией:
