...
Не угадывать legacy-кодировку и не переписывать файл после декодирования с заменой символов. При неоднозначности остановить преобразование, сообщить обнаруженные байты/BOM и запросить решение.
...
6. Для анализа и преобразования кодировки использовать скрипты `safe-text-io`; не полагаться на дефолты shell.
